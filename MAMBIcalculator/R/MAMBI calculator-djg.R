...
MAMBI.DJG<-function(BenthicData_and_path, EG_File_Name="data/Ref - EG Values 2018.csv", EG_Scheme="Hybrid")
  {
  require(tidyverse)
  require(reshape2)
  require(vegan)
  ...
  devtools::use_data("saline_standards")
  devtools::use_data("tidalFresh_Standards")
  devtools::use_data("EG_Ref")
  # make this a dataframe and store as Rdata file in 'data' folder
  ...
  # EG_Ref <- read.csv(EG_File_Name, stringsAsFactors = F, na.strings = "") %>%
